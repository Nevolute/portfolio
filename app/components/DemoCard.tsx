...
export default function DemoCard({ title, description, imageUrl, demoUrl, tags }: DemoCardProps) {
  return (
    <div className="bg-purple-950/30 border border-purple-800/30 rounded-2xl overflow-hidden card-hover group">
      ...
      <div className="p-6">
        ...
        <p className="text-purple-200/60 text-sm mb-4">{description}</p>
        <a
          href={demoUrl}
          target="_blank"
